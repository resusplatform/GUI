...
public class ModelResultConverterRegex extends AbstractSection {
	...
	public void createControls(Composite parent,
		...
		btnAddDouble.setBounds(580, 5, 65, 22);
		...
		btnAddInteger.setBounds(660, 5, 75, 22);
		...
		btnAddSpace.setBounds(745, 5, 75, 22);
		...
		Button btnChecker=new Button(composite,SWT.NONE);
		btnChecker.setBounds(650, 31, 150, 23);
		btnChecker.setText("RegEx Checker");
		btnChecker.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
			
						
				Path resusHomeregexexe=ResusSettings.chekReSUS_HOME_regex();
				if(resusHomeregexexe==null)
					return;
				
				Path pathToregexfolder=resusHomeregexexe.getParent();
				if(pathToregexfolder==null)
					return;
				//---
				
				ProcessBuilder builder = new ProcessBuilder(
						resusHomeregexexe.toString());
				builder.directory(pathToregexfolder.toFile());
