 ...
 */
public class ResusElementLabelProvider	extends LabelProvider {
	 ...
	 * constructor.
	 */
	public ResusElementLabelProvider() {
		super();
		typeMapper = new ResusElementTypeMapper();
	}
	...
	public Image getImage(Object objects) {
		...
		if (object == null) {
			ImageDescriptor imageDescriptor = ImageDescriptor.createFromFile(
				ResusModel.class, "icons/comp.gif");//$NON-NLS-1$
			...
			if (element instanceof Connector) {
				ImageDescriptor imageDescriptor = ImageDescriptor
					.createFromFile(ResusModel.class, "icons/connection16.gif");//$NON-NLS-1$
				return imageDescriptor.createImage();
			}
