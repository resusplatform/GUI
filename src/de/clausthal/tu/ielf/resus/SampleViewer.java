...
public class SampleViewer extends MessageDialog {
	  ...
	  public void refresh(){
		  try {
			  ...
			  attributes=new ArrayList<Parameter>();
	        	...
	        	MessageDialog.openError(null, "error", "invalid HDF5 file");
	        	//ex.printStackTrace();
	            return;
   ...
   //--------------------- end of table---------------
	...
	String ReadAttribute(String datasetname,String attName) throws NullPointerException, HDF5Exception {
		String attValue="";
		int file_id = -1;
		int filetype_id = -1;
		int memtype_id = -1;
