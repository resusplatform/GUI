...
public class NewResusSimulationWizard extends Wizard implements INewWizard  {
	
	private IStructuredSelection selection;
	private IWorkbench workbench;

	private NewResusSimulationPageOneWizard pageone;
	private NewResusSimulationPageTwoWizard pagetwo;
	@Override
	  public void addPages() {
		pageone = new NewResusSimulationPageOneWizard();
	    pagetwo = new NewResusSimulationPageTwoWizard();
	    addPage(pageone);
	    addPage(pagetwo);
