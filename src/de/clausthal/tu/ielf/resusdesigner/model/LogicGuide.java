...
public class LogicGuide implements Serializable {
	 ...
	 */
	public void attachPart(ResusSubpart part, int alignment) {
	 ...
	 */
	public void detachPart(ResusSubpart part) {
	 ...
	 * {@link de.clausthal.tu.ielf.resusdesigner.edit.ResusXYLayoutEditPolicy
	 ...
	 * @see de.clausthal.tu.ielf.resusdesigner.edit.ResusXYLayoutEditPolicy#createChangeConstraintCommand(ChangeBoundsRequest,
	 *      EditPart, Object)
	 */
	public int getAlignment(ResusSubpart part) {
