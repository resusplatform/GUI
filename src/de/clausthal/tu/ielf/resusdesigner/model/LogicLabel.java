...
public class LogicLabel extends ResusSubpart {

	private static final int DEFAULT_WIDTH = 50;

	static final long serialVersionUID = 1;

	private String text = ResusMessages.LogicPlugin_Tool_CreationTool_LogicLabel;

	private static Image LOGIC_LABEL_ICON = createImage(LogicLabel.class,
	...
	public String toString() {
		return ResusMessages.LogicPlugin_Tool_CreationTool_LogicLabel
				+ " #" + getId() + " " //$NON-NLS-1$ //$NON-NLS-2$
				+ ResusMessages.PropertyDescriptor_Label_Text
