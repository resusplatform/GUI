 ...
 */
public class ResusTreeEditPart extends
	 ...
	 *            Model for this.
	 */
	public ResusTreeEditPart(Object model) {
		super(model);
	}
	...
	public void propertyChange(PropertyChangeEvent change) {
		if (change.getPropertyName().equals(ResusDiagram.CHILDREN)) {
