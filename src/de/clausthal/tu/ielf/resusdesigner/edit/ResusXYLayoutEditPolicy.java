...
public class ResusXYLayoutEditPolicy extends
		org.eclipse.gef.editpolicies.XYLayoutEditPolicy {

	public ResusXYLayoutEditPolicy(XYLayout layout) {
		super();
		setXyLayout(layout);
	}
	...
	protected IFigure createSizeOnDropFeedback(CreateRequest createRequest) {
		...
		else if (createRequest.getNewObject() instanceof InputProvider)
			figure = new InputProviderFeedbackFigure((InputProvider)createRequest.getNewObject());
		else if (createRequest.getNewObject() instanceof ResultConverter)
