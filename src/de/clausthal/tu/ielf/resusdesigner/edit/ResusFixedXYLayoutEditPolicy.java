...
public class ResusFixedXYLayoutEditPolicy extends
		org.eclipse.gef.editpolicies.XYLayoutEditPolicy {

	public ResusFixedXYLayoutEditPolicy(XYLayout layout) {
		super();
		setXyLayout(layout);
	}
	...
	protected IFigure createSizeOnDropFeedback(CreateRequest createRequest) {
		...
		if (createRequest.getNewObject() instanceof InputProvider)
