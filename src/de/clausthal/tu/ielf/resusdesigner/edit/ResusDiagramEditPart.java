 ...
 */
public class ResusDiagramEditPart extends ResusContainerEditPart implements
		LayerConstants {

	protected AccessibleEditPart createAccessible() {
		return new AccessibleGraphicalEditPart() {
			public void getName(AccessibleEvent e) {
				e.result = ResusMessages.LogicDiagram_LabelText;
			}
		};
	}
	...
	protected void createEditPolicies() {
		...
		installEditPolicy(EditPolicy.LAYOUT_ROLE, new ResusXYLayoutEditPolicy(
