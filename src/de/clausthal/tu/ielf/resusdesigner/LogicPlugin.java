...
public class LogicPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	...
	static private PaletteContainer createComponentsDrawer() {
		...
		combined = new CombinedTemplateCreationEntry(
				...
				new SimpleFactory(IOProvider.class), ImageDescriptor
						.createFromFile(IOProvider.class, "icons/ResusIOProvider16.gif"),//$NON-NLS-1$
				ImageDescriptor.createFromFile(IOProvider.class,
