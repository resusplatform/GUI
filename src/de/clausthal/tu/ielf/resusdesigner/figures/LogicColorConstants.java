...
public interface LogicColorConstants {
	...
	public final static Color logicBlue = new Color(null, 0, 100, 150);
	public final static Color logicRed = new Color(null, 200, 10, 80);
	...
	public final static Color connectorBlack = new Color(null, 10,5,5);
	...
	public final static Color logicTextWhite = new Color(null, 255, 255, 255);
//	public final static Color ghostFillColor = new Color(null, 31, 31, 31);
//	public final static Color ghostFillColor = new Color(null, 31, 31, 31);
