...
public class InputProviderFigure extends NodeFigure implements HandleBounds {

	private ScrollPane scrollpane;
	private InputProvider source;

	public InputProviderFigure(InputProvider src) {
		source=src;
		setBorder(new InputProviderBorder(src));
