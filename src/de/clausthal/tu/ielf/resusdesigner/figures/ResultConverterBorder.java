...
public class ResultConverterBorder extends AbstractBorder {

	public ResultConverterBorder(ResultConverter src){
		source=src;
	}
	protected ResultConverter source=null;
...
//			outputConnector.translate(-x1, -end);
	...
	public void paint(IFigure figure, Graphics g, Insets in) {
		...
		g.drawText("Result", r.x+5, r.y+30);
		g.drawText("Converter", r.x+5, r.y+42);
